<?php
/*
 * Template for displaying 401 pages.
		...
		<div id="content" role="main">
			...
			<article id="post-0" class="post error404 no-results not-found">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'Error 401: Unauthorized!', 'themonic' ); ?></h1>
				</header>

				<div class="entry-content">
					<p><?php _e( 'Sorry, either you are not permitted to access this resource or authorization has not been set up.', 'themonic' ); ?></p>
