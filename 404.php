		...
		<div id="content" role="main">
			...
			<article id="post-0" class="post error404 no-results not-found">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'Error 404: Page not found!', 'themonic' ); ?></h1>
				</header>

				<div class="entry-content">
					<p><?php _e( 'Sorry, I couldn\'t find what you\'re looking for. It could be my fault.', 'themonic' ); ?></p>
